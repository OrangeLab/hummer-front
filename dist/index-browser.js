var __GLOBAL__ = (function (exports) {
  'use strict';
  ...
  })(exports.LongPressState || (exports.LongPressState = {}));
  ...
  })(exports.PanState || (exports.PanState = {}));
  ...
  })(exports.PinchState || (exports.PinchState = {}));
  class PinchEvent extends Event {
      get type() {
          return 'pinch';
      }
  }

  exports.ScrollState = void 0;
  (function (ScrollState) {
      ...
      ScrollState[ScrollState["SCROLL_UP"] = 4] = "SCROLL_UP";
  })(exports.ScrollState || (exports.ScrollState = {}));
  ...
  })(exports.SwipeState || (exports.SwipeState = {}));
  ...
  })(exports.TapState || (exports.TapState = {}));
  ...
  (function (TouchState) {
      ...
      TouchState[TouchState["BEGAN"] = 1] = "BEGAN";
      TouchState[TouchState["CHANGED"] = 2] = "CHANGED";
      TouchState[TouchState["ENDED"] = 3] = "ENDED";
      TouchState[TouchState["CANCELLED"] = 4] = "CANCELLED";
  })(exports.TouchState || (exports.TouchState = {}));
  ...
  class View {
          ...
          if (!this.eventListeners[key]) {
              if (key === 'longPress') {
                  const press = (e) => {
                      ...
                      ev.state = exports.LongPressState.BEGAN;
                  ...
                  const pressup = (e) => {
                      ...
                      ev.target = this;
                      ev.timestamp = e.timeStamp;
                      ev.state = exports.LongPressState.ENDED;
                      this.listeners[key].forEach(listener => listener(ev));
                  };
                  ...
                  const panstart = (e) => {
                      ...
                      ev.target = this;
                      ev.timestamp = e.timeStamp;
                      ev.state = exports.PanState.BEGAN;
                  ...
                  const panmove = (e) => {
                      ...
                      ev.target = this;
                      ev.timestamp = e.timeStamp;
                      ev.state = exports.PanState.CHANGED;
                      ev.translation = { deltaX: e.deltaX + 'dp', deltaY: e.deltaY + 'dp' };
                      this.listeners[key].forEach(listener => listener(ev));
                  };
                  const panend = (e) => {
                      ...
                      ev.target = this;
                      ev.timestamp = e.timeStamp;
                      ev.state = exports.PanState.ENDED;
                      ev.translation = { deltaX: e.deltaX + 'dp', deltaY: e.deltaY + 'dp' };
                      this.listeners[key].forEach(listener => listener(ev));
                  };
                  const pancancel = (e) => {
                      ...
                      ev.target = this;
                      ev.timestamp = e.timeStamp;
                      ev.state = exports.PanState.CANCELLED;
                      ev.translation = { deltaX: e.deltaX + 'dp', deltaY: e.deltaY + 'dp' };
                      this.listeners[key].forEach(listener => listener(ev));
                  };
                  const hammer = new Hammer(this.node);
                  ...
                  const pinchstart = (e) => {
                      ...
                      ev.target = this;
                      ev.timestamp = e.timeStamp;
                      ev.state = exports.PinchState.BEGAN;
                      ev.scale = e.scale;
                      this.listeners[key].forEach(listener => listener(ev));
                  };
                  const pinchmove = (e) => {
                      ...
                      ev.target = this;
                      ev.timestamp = e.timeStamp;
                      ev.state = exports.PinchState.CHANGED;
                      ev.scale = e.scale;
                      this.listeners[key].forEach(listener => listener(ev));
                  };
                  const pinchend = (e) => {
                      ...
                      ev.target = this;
                      ev.timestamp = e.timeStamp;
                      ev.state = exports.PinchState.ENDED;
                      ev.scale = e.scale;
                      this.listeners[key].forEach(listener => listener(ev));
                  };
                  const pinchcancel = (e) => {
                      ...
                      ev.target = this;
                      ev.timestamp = e.timeStamp;
                      ev.state = exports.PinchState.CANCELLED;
                      ev.scale = e.scale;
                      this.listeners[key].forEach(listener => listener(ev));
                  };
                  const hammer = new Hammer(this.node);
                  ...
                  const swipeleft = (e) => {
                      ...
                      ev.target = this;
                      ev.timestamp = e.timeStamp;
                      ev.state = exports.SwipeState.BEGAN;
                      ev.direction = 'left';
                      this.listeners[key].forEach(listener => listener(ev));
                  };
                  const swiperight = (e) => {
                  ...
                  const tap = (event) => {
                      ...
                      ev.state = exports.TapState.BEGAN;
                      this.listeners[key].forEach(listener => listener(ev));
                  };
                  const hammer = new Hammer(this.node);
                  hammer.on(key, tap);
                  ...
                  const input = (e) => {
                      ...
                      ev.target = this;
                      ev.state = exports.InputState.CHANGED;
                  ...
                  const focus = (e) => {
                      ...
                      const ev = new InputEvent();
                      ev.target = this;
                      ev.state = exports.InputState.BEGAN;
                      ev.text = e.target.value;
                      this.listeners[key].forEach(listener => listener(ev));
                  };
                  const blur = (e) => {
                      ...
                      const ev = new InputEvent();
                      ev.target = this;
                      ev.state = exports.InputState.ENDED;
                      ev.text = e.target.value;
                      this.listeners[key].forEach(listener => listener(ev));
                  };
      ...
      addAnimation(animation, key) {
          if (animation instanceof BasicAnimation) {
              const { keyframes, options } = this.getBasicAnimationKeyFrameAnimationOptions(animation);
              const that = this;
              const animate = that.node.animate(keyframes, options);
              this.animations[key] = animate;
              animation.onstart && animation.onstart();
              animation.onend && (animate.oncancel = animation.onend);
              animate.play();
          }
          else if (animation instanceof KeyframeAnimation) {
              const { keyframes, options } = this.getKeyframeAnimationOptions(animation);
              const animate = this.node.animate(keyframes, options);
              this.animations[key] = animate;
              animation.onstart && animation.onstart();
              animation.onend && (animate.oncancel = animation.onend);
              animate.play();
      ...
      removeAllAnimation() {
          for (let key in this.animations) {
              const animate = this.animations[key];
              animate.pause();
              animate.finish();
          }
          this.animations = {};
      ...
      getRect(callback) { }
      resetStyle() { }
      requestViewWidth(callback) { }
      requestViewHeight(callback) { }
      getBasicAnimationDefaultKeyframeAnimationOptions(ani) {
          switch (ani.path) {
              case 'position':
              case 'scale':
              case 'scaleX':
      ...
      getBasicAnimationKeyFrameAnimationOptions(ani) {
          return {
              keyframes: [
      ...
      getKeyframeAnimationOptions(ani) {
  ...
  class Image extends View {
      ...
      set gifRepeatCount(gifRepeatCount) { }
      set onload(onload) {
  ...
  const INPUT_SIZE_STYLE = ['fontSize'].concat(SIZE_STYLE);
  ...
  var bscroll = bscroll$1.exports;

  var BScroll = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.assign(/*#__PURE__*/Object.create(null), bscroll$1.exports, {
    'default': bscroll
  }));
  ...
  class Scroller extends View {
      ...
      registerBsScrollEvent() {
          if (this.bscroll) {
              const scrollStart = () => {
                  const ev = new ScrollEvent();
                  ev.target = this;
                  ev.state = exports.ScrollState.BEGAN;
              ...
              const scroll = (e) => {
                  const ev = new ScrollEvent();
                  ev.target = this;
                  ev.state = exports.ScrollState.SCROLL;
                  ev.timestamp = `${Date.now()}`;
                  ev.dx = e.x;
                  ev.dy = e.y;
                  this.listeners['scroll'].forEach(listener => listener(ev));
              ...
              const scrollEnd = (e) => {
                  const ev = new ScrollEvent();
                  ev.target = this;
                  ev.state = exports.ScrollState.ENDED;
                  ev.timestamp = `${Date.now()}`;
                  ev.dx = e.x;
                  ev.dy = e.y;
                  this.listeners['scroll'].forEach(listener => listener(ev));
  ...
  exports.HummerGlobal = HummerGlobal;
  exports.INPUT_SIZE_STYLE = INPUT_SIZE_STYLE;
  exports.Image = Image;
  ...
  exports.Phone = Phone;
  exports.PinchEvent = PinchEvent;
  exports.Request = Request;
  exports.Response = Response;
  exports.SIZE_STYLE = SIZE_STYLE;
  exports.ScrollEvent = ScrollEvent;
  exports.Scroller = Scroller;
  exports.Storage = Storage;
  exports.SwipeEvent = SwipeEvent;
  exports.Switch = Switch;
  exports.SwitchEvent = SwitchEvent;
